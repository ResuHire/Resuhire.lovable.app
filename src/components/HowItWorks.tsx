                ...
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer h-full">
                  <CardContent className="p-8 text-center">
                    <div className="relative mb-6">
                      ...
                      <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 mt-4`}>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {weeklyHighlights.map((period, index) => (
              <Card key={index} className="border border-purple-100 hover:shadow-lg transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <h4 className="text-lg font-bold mb-2">{period.focus}</h4>
